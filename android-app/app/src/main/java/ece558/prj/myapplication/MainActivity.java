...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final String url =
        "https://firebasestorage.googleapis.com/v0/b/final-project-backend.appspot.com/o/models.jpg?alt=media&token=6e40413c-d965-4722-a1e6-ef80f1b337c7";
    ...
    // storage.getReferenceFromUrl("gs://final-project-backend.appspot.com/models.jpg");
